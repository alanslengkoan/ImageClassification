...
fig.suptitle('Perbandingan ResNet50 vs MobileNetV2\nKlasifikasi Kerusakan Jalan (3 Kelas)',
...
fig.suptitle('Confusion Matrix — ResNet50 vs MobileNetV2\nKlasifikasi Kerusakan Jalan (3 Kelas)',
             fontsize=14, fontweight='bold')
...
fig.suptitle('ROC Curve per Kelas — ResNet50 vs MobileNetV2\nKlasifikasi Kerusakan Jalan',
